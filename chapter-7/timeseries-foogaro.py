...
while current_date <= end_date:
    ...
    client.execute_command('TS.ADD', time_series_key, timestamp, value, 'LABELS', 'dev', 'java', 'database', 'redis')
    current_date += delta
print("Site https://foogaro.com completed")
