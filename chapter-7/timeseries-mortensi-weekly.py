...
client.execute_command('DEL', time_series_key + ':weekly')

client.execute_command('TS.CREATE', time_series_key)
client.execute_command('TS.CREATE', time_series_key + ':weekly')
client.execute_command('TS.CREATERULE', time_series_key, time_series_key + ':weekly', 'AGGREGATION', 'sum', 604800000)
